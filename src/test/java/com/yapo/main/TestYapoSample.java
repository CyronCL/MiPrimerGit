...
public class TestYapoSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WebElement publicarAviso = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.cssSelector(".header-right .btn-home"))));
        ...
        Thread.sleep(1000);
        WebElement categoria = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.cssSelector("#category_group"))));
        ...
        Thread.sleep(1000);
        WebElement tipoInmueble = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.cssSelector("#estate_type"))));
        ...
        Thread.sleep(1000);
        WebElement dormitorios = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.cssSelector("#rooms"))));
        ...
        Thread.sleep(1000);
        WebElement banos = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.cssSelector("#bathrooms"))));
        ...
        Thread.sleep(1000);
        WebElement equipamientoBodega = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.cssSelector("#eqp_3_1"))));
        System.out.println("Seleccionando bodega");
        if (!equipamientoBodega.isSelected())
            equipamientoBodega.click();

        Thread.sleep(1000);
        WebElement tamano = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.cssSelector("#size"))));
        System.out.println("Ingresando tamaño");
        tamano.sendKeys("120");

        Thread.sleep(1000);
        WebElement gastoComun = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.cssSelector("#condominio"))));
        System.out.println("Ingresando valor proximado del gasto comun");
        gastoComun.sendKeys("60000");

        Thread.sleep(1000);
        WebElement titulo = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.cssSelector("#subject"))));
        ...
        Thread.sleep(1000);
        WebElement descripcion = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.cssSelector("#body"))));
        System.out.println("Ingresando un titulo");
